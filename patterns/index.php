...
<div class="wp-block-group alignfull"><!-- wp:site-title {"textAlign":"center","isLink":false,"align":"full"} /-->
...
<!-- wp:heading {"textAlign":"center","align":"full","style":{"typography":{"fontSize":"7rem"}}} -->
<h2 class="wp-block-heading alignfull has-text-align-center" style="font-size:7rem"><?php echo __('Captain\'s log', 'pirates');?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-group alignwide"><!-- wp:template-part {"slug":"footer","tagName":"footer","align":"full"} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group -->